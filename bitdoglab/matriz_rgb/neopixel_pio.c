...
int main()
{
  ...
  {
    int matriz[5][5][3] = {
        {{23, 137, 10}, {0, 0, 0}, {23, 137, 10}, {0, 0, 0}, {23, 137, 10}},
        {{0, 0, 0}, {23, 137, 10}, {0, 0, 0}, {23, 137, 10}, {0, 0, 0}},
        {{23, 137, 10}, {0, 0, 0}, {23, 137, 10}, {0, 0, 0}, {23, 137, 10}},
        {{0, 0, 0}, {23, 137, 10}, {0, 0, 0}, {23, 137, 10}, {0, 0, 0}},
        {{23, 137, 10}, {0, 0, 0}, {23, 137, 10}, {0, 0, 0}, {23, 137, 10}}};
    ...
    npClear();
    int matriz2[5][5][3] = {
        {{0, 0, 0}, {183, 187, 15}, {0, 0, 0}, {183, 187, 15}, {0, 0, 0}},
        {{183, 187, 15}, {0, 0, 0}, {183, 187, 15}, {0, 0, 0}, {183, 187, 15}},
        {{0, 0, 0}, {183, 187, 15}, {0, 0, 0}, {183, 187, 15}, {0, 0, 0}},
        {{183, 187, 15}, {0, 0, 0}, {183, 187, 15}, {0, 0, 0}, {183, 187, 15}},
        {{0, 0, 0}, {183, 187, 15}, {0, 0, 0}, {183, 187, 15}, {0, 0, 0}}};
    // Desenhando Sprite contido na matriz.c
